...
function getProductsByID() {
  ...
  axios({
    ...
    document.getElementById('us').value=res.data.UnitsInStock
    document.getElementById('uo').value=res.data.UnitsOnOrder
...
function lastID() {
  axios({
    ...
    nuevoDetalleOrden(res.data.OrderID)
...
function orderIDAutomatico() {
  axios({
    ...
    document.getElementById('orderID').value=res.data.OrderID +1
...
function updateExistencias() {
  ...
  let existencias = {
    UnitsInStock:document.getElementById('us').value-document.getElementById('cantidad').value,
    UnitsOnOrder:document.getElementById('uo').value+document.getElementById('cantidad').value,
}
  ...
  axios({
      ...
      url: 'http://localhost:3300/existencias/'+ document.getElementById('productos').value,
      responseType: 'json', //tipo de respuesta
      data: existencias
  }).then(res => { //inicia la promesa
...
function info(id) {
  axios({
    ...
    method: 'GET', //metodo de solicitud
    url: 'http://localhost:3300/infoFacturaOrder/'+id, //url del API
    responseType: 'json', //tipo de respuesta
  ...
  axios({
    ...
    for (const key in res.data) {
      ...
      document.getElementById("DFactura").insertRow(-1).innerHTML = 
                    ...
                    +Number(res.data[key].Discount).toFixed(2)+'</td>\
                    <td class="align="center" >'+'&nbsp;'+'&nbsp;'+'&nbsp;'+'&nbsp;'+'&nbsp;'+'&nbsp;Lps. '
                    +res.data[key].UnitPrice+'</td>'

      descuento=res.data[key].UnitPrice*Number(res.data[key].Discount)
